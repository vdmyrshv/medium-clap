...
const MediumClap = () => {
  ...
  return <button ref={setRef} data-refkey="clapRef" onClick={handleClapClick} className={styles.clap}>
    <ClapIcon isClicked={clapState.isClicked}/>
    <ClapCount count={clapState.count} setRef={setRef}/>
    <TotalClap countTotal={clapState.countTotal} setRef={setRef}/>
  </button>
}
...
const TotalClap = ({countTotal, setRef}) => {
