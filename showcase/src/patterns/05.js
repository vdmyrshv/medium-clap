...
//style prop here renamed to userStyle to imply it's a customized style
const MediumClap = ({
	children,
    onClap,
    values = null,
    ...
    //remember with short circuit && notation both parts have to be boolean
    // with short circuit || they don't, the expression will 
	...
	return (
		<Provider value={memoizedValue}>
			<button
				...
				className={classNames} //how to join default settings and classNames seen above
				style={userStyles}
			>
				{children}
			</button>
...
const ClapIcon = ({ style: userStyles = {}, className }) => {
	...
	//simple operations within an aray ARE allowed, see ternary below
	const classNames = [
		styles.icon,
